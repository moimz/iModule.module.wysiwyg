...
(function($) {
	$.fn.wysiwyg = function(isReload) {
		...
		if ($textarea.is("div") == true) {
			...
			var pasteDeniedTags = ["abbr","address","article","aside","audio","base","bdi","bdo","blockquote","button","canvas","caption","cite","code","col","colgroup","datalist","dd","del","details","dfn","dialog","dl","dt","em","embed","fieldset","figcaption","figure","footer","form","header","hgroup","iframe","input","ins","kbd","keygen","label","legend","link","main","mark","menu","menuitem","meter","nav","noscript","object","optgroup","option","output","param","pre","progress","queue","rp","rt","ruby","s","samp","script","style","section","select","small","source","span","strike","strong","summary","textarea","time","title","tr","track","var","video","wbr"];
